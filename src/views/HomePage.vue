<template>
    ...
    <div class="index_home">
        ...
        <div class="row gx-0 index_home-content">
            ...
            <div class="col-lg-10 col-md-12 index_center">
                <!-- view-marker -->
                <div class="row">
                    <div class="col index_view-marker"></div>
                </div>
                <!-- co-living-slider -->
                <div class="row">
                    <div
                    ...
                    >
                        <div class="row gx-0">
                            ...
                            <div class="col-lg-6 index_right">
